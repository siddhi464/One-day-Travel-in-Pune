...
public class myframe5_c extends JFrame{
	JButton no1 = new JButton("A cafe or a restaurant");
	JButton no2 = new JButton("Tourist hub");

	myframe5_c(){
		//default
	}
	myframe5_c(double total,int tm, String current, int wait, ArrayList pickup,ArrayList dropoff){
		try {
		...
		panel5.setLayout(new GridLayout(5,0,0,0));
        ...
        JLabel label5 = new JLabel("Would you like to visit a:");
		panel5.add(label5);
      ...
      panel5.add(no2);
            ...
            no1.addActionListener(new ActionListener() {
              ...
              //      String selectedOption = ; // Update selectedOption with the chosen option
                	char choice = 1;
                	System.out.println("no1." + choice);
                	myframe5_c2 obj=new myframe5_c2(choice, total, tm, current, wait,pickup,dropoff);
                	frame.dispose();
                }   
            });
